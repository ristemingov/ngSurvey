...
export class QuestionTypesService {
  questionTypes: {title: string, description: string}[] = [
    ...
    {title: 'Dichotomous questions', description: 'These close ended question are indicative questions that can be answered either in one of the two ways, “yes” or “no” or “true” or “false”. Closed-ended questions are sometimes phrased as a statement which requires a response.'},
